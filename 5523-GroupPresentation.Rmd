...
df1$comfort <- factor(df1$comfort, levels = c("wet", "comfort", "dry"), labels = c("wet", "comfort", "dry"))
...
wet <- max(filter(df3, comfort == "wet")$n)
dry <- max(filter(df3, comfort == "dry")$n)
comfort <- max(filter(df3, comfort == "comfort")$n)
