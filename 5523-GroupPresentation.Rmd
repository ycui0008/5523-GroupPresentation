...
.panelset[
.panel[.panel-name[RH Avg (Sensors)]
...
```{r heatmap2, echo = FALSE, out.width="80%", fig.height=4.5}
dates <- df2 %>% 
...
```{r heatmap3, echo = FALSE, out.width="80%", fig.height=4.5}
dates <- df2 %>% 
...
```{r heatmap4, echo = FALSE, out.width="80%", fig.height=4.5}
dates <- df2 %>% 
...
```{r heatmap5, echo = FALSE, out.width="80%", fig.height=4.5}
dates <- df2 %>% 
...
```{r heatmap1, echo = FALSE, out.width="80%", fig.height=4.5}
dates <- df2 %>% 
  filter(site_id == "arc1045") %>% 
  pull(date)
